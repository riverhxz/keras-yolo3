...
def _main():
    ...
    #             in enumerate(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes)):
    ...
    for (i,(x,y)) in enumerate(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes)):
        def print_shape(*args):
            print(i,*[x.shape for x in args], sep= " ||| ")
